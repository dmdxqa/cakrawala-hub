# Sales Order PASS Workflow

## Overview

Outlines the positive flow for Sales Order PASS (Procurement/Purchase Approval Sales Order) creation, editing, and cancellation. This document serves as the primary reference for validating the procurement order creation process, verifying order modifications while in Draft status, and testing order cancellation before deployment.
...
4. Click **Save** button
5. Verify new Sales Order PASS is created with **Draft** status and is listed in the Sales Order table

---

### View Sales Order PASS Details
...
7. Click **Save** button
8. Verify the updated Sales Order PASS is saved and reflected in the list

---

### Cancel Sales Order PASS
