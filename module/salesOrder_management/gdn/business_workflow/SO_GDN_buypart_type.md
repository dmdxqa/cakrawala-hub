...
6. Select **Non Local Part** by clicking **Add** from the table
    - **Sales Order Buy Part Type** ONLY shown **Non Local Part**
...
### Receive Part from CPC

1. User navigate to **Part Request** section
2. Click **Action** button and select **Receive Part** button
3. Verify **Part** status change to **Received**
    - Stock for part request also increase based on total amount request
